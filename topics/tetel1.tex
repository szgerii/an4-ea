...
Ehhez a bizonyításhoz szükséges az implicitfüggvény-tétel (ld. \ref{sec:impl-fv}) ismerete, de hasznos az egész következő fejezet (ld. \ref{chapter:tetel2} tétel) előzőleges átolvasása.
\vspace{4pt}
\textsc{Tétel (emlékeztető)}
...
Egy gyors lebontása az "objektumainknak", támpontnak a bizonyítás során:
