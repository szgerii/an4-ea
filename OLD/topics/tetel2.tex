...
A következő feladat a feltételes szélsőérték és (utólagosan) az implicitfüggvények felvezetésére szolgál.
...
A fenti feladat ezzel az intuícióval több változóra is kiáltalánosítható, a feltételes szélsőérték (és az implicitfüggvény) fogalmának bevezetésével.
...
Tehát,
\begin{equation*}
\grad (f + \lambda g)(c) = \left( \partial_1f(c) + \sum_{l=1}^m \lambda_l \cdot \partial_1g_l(c), \ldots, \partial_n f(c) + \sum_{l=1}^m \lambda_l \cdot \partial_n g_l(c) \right) = 0
\qed
\end{equation*}
